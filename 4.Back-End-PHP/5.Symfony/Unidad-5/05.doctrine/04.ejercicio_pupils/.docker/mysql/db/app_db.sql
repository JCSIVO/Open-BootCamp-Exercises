...
--
-- Servidor: db:3306
-- Tiempo de generación: 28-12-2021 a las 17:43:53
...
CREATE TABLE `asignatura` (
  ...
  `codigo` int NOT NULL,
  `nombre` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nombre_ingles` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `nota` (`id`, `asignatura_id`, `alumno_id`, `n_convocatoria`, `fecha`, `nota`) VALUES
(1, 3, 1, 1, '2016-06-10', 3.7),
(2, 3, 1, 2, '2017-10-24', 6.2),
(3, 4, 1, 1, '2017-10-27', 8),
(4, 8, 4, 1, '2018-08-14', 6),
(5, 6, 4, 1, '2018-08-21', 7);
